...
export const metadata: Metadata = {
  title: 'Climbing Map',
  description: 'Use this climbing map to explore crags from Guernsey to Skye, view route lines, and open photo topos for local climbs.',
  alternates: {
    canonical: '/climbing-map',
  },
  openGraph: {
    title: 'Climbing Map - letsboulder',
    description: 'Explore climbing routes and photo topos on an interactive map, including Skye, Scotland, and Guernsey.',
    url: '/climbing-map',
    images: ['/og.png'],
  },
  twitter: {
...
export default async function ClimbingMapPage() {
  ...
  const webPageSchema = {
    ...
    description: 'Interactive climbing map with topo images, route detail pages, and community beta across UK and Channel Islands crags.',
  }
    ...
    <>
      ...
      <section className="relative z-10 mt-[100vh] border-t border-gray-200 bg-white/95 px-4 py-8 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-950/95">
        <div className="mx-auto max-w-5xl">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Interactive climbing map for Skye, Scotland, and Guernsey</h1>
          <p className="mt-3 max-w-3xl text-sm text-gray-600 dark:text-gray-300">
            View climbing locations on the map, open photo topos, and jump directly to route pages with grade and route beta.
          </p>
