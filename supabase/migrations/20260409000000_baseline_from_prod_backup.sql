...
CREATE OR REPLACE FUNCTION "public"."add_correction_type_value"("p_type" "text", "p_value" "text") RETURNS "void"
...
ALTER FUNCTION "public"."add_correction_type_value"("p_type" "text", "p_value" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_notification"("p_target_user_id" "uuid", "p_type" character varying, "p_title" "text", "p_message" "text" DEFAULT NULL::"text", "p_link" "text" DEFAULT NULL::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_notification"("p_target_user_id" "uuid", "p_type" character varying, "p_title" "text", "p_message" "text", "p_link" "text") OWNER TO "postgres";
...
DECLARE
  ...
  sector_id UUID;
  supplementary_sector_id UUID;
  primary_upload_uuid UUID;
...
BEGIN
  ...
  sector_id := NULLIF(p_primary_image->>'sector_id', '')::UUID;
...
CREATE OR REPLACE FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) RETURNS TABLE("deleted_profile" boolean, "deleted_route_upload_images" integer, "deleted_user_climbs" integer, "deleted_logs" integer, "nullified_images" integer, "deleted_images" integer, "nullified_climbs" integer, "deleted_climbs" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_climbs_with_consensus"() RETURNS TABLE("id" "uuid", "name" "text", "grade" "text", "consensus_grade" "text", "total_votes" bigint, "grade_tied" boolean, "crag_id" "uuid", "place_id" "uuid")
    LANGUAGE "sql" STABLE
    AS $$
  SELECT
    c.id,
...
ALTER FUNCTION "public"."get_climbs_with_consensus"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text" DEFAULT 'tops'::"text", "p_page" integer DEFAULT 1, "p_limit" integer DEFAULT 20, "p_window_start" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS TABLE("rank" bigint, "user_id" "uuid", "username" "text", "avatar_url" "text", "avg_grade" "text", "climb_count" bigint, "total_users" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text" DEFAULT NULL::"text", "p_region_id" "uuid" DEFAULT NULL::"uuid", "p_sort" "text" DEFAULT 'grade'::"text", "p_page" integer DEFAULT 1, "p_limit" integer DEFAULT 20, "p_window_start" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS TABLE("rank" bigint, "user_id" "uuid", "username" "text", "avatar_url" "text", "avg_grade" "text", "climb_count" bigint, "total_users" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  WITH filtered_climbs AS (
...
ALTER FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text", "p_region_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_upload_context"("search_lat" double precision, "search_lng" double precision) RETURNS json
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
    result JSON;
...
ALTER FUNCTION "public"."get_upload_context"("search_lat" double precision, "search_lng" double precision) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."crag_images" (
    ...
    CONSTRAINT "crag_images_latitude_check" CHECK ((("latitude" IS NULL) OR (("latitude" >= ('-90'::integer)::numeric) AND ("latitude" <= (90)::numeric)))),
    CONSTRAINT "crag_images_longitude_check" CHECK ((("longitude" IS NULL) OR (("longitude" >= ('-180'::integer)::numeric) AND ("longitude" <= (180)::numeric)))),
...
CREATE OR REPLACE FUNCTION "public"."rankings_grade_from_points"("p_points" integer) RETURNS "text"
...
ALTER FUNCTION "public"."rankings_grade_from_points"("p_points" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."soft_delete_comments_on_target_delete"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE public.comments
...
ALTER FUNCTION "public"."soft_delete_comments_on_target_delete"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public'
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."images" (
    ...
    "submission_id" "uuid",
    "face_order" integer,
    "location_mode" "text" DEFAULT 'shared'::"text",
    ...
    CONSTRAINT "images_location_mode_check" CHECK (("location_mode" = ANY (ARRAY['shared'::"text", 'custom'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."submission_draft_routes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "draft_id" "uuid" NOT NULL,
    "draft_image_id" "uuid" NOT NULL,
    "name" "text" DEFAULT 'Unnamed route'::"text" NOT NULL,
    "grade" "text" DEFAULT '6A'::"text" NOT NULL,
    "description" "text",
    "climb_type" "text" DEFAULT 'sport'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "submission_draft_routes_climb_type_check" CHECK (("climb_type" = ANY (ARRAY['sport'::"text", 'boulder'::"text", 'trad'::"text", 'deep-water-solo'::"text"]))),
    CONSTRAINT "submission_draft_routes_points_is_array" CHECK (("jsonb_typeof"("points") = 'array'::"text"))
);


ALTER TABLE "public"."submission_draft_routes" OWNER TO "postgres";


COMMENT ON TABLE "public"."submission_draft_routes" IS 'Durable per-image draft routes. RLS: FOR ALL gated by draft status + owner/collaborator check.';
...
ALTER TABLE "public"."un_regions" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."continents"
    ADD CONSTRAINT "continents_pkey" PRIMARY KEY ("name");
...
ALTER TABLE ONLY "public"."countries"
    ADD CONSTRAINT "countries_iso_a2_key" UNIQUE ("iso_a2");



ALTER TABLE ONLY "public"."countries"
    ADD CONSTRAINT "countries_iso_a3_key" UNIQUE ("iso_a3");
...
ALTER TABLE ONLY "public"."submission_draft_routes"
    ADD CONSTRAINT "submission_draft_routes_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."un_regions"
    ADD CONSTRAINT "un_regions_pkey" PRIMARY KEY ("name");
...
CREATE INDEX "idx_countries_boundary" ON "public"."countries" USING "gist" ("boundary");
...
CREATE INDEX "idx_crag_images_location" ON "public"."crag_images" USING "btree" ("latitude", "longitude");
...
CREATE INDEX "idx_crags_country_id" ON "public"."crags" USING "btree" ("country_id");
...
CREATE INDEX "idx_images_continent" ON "public"."images" USING "btree" ("continent_name");



CREATE INDEX "idx_images_country_code" ON "public"."images" USING "btree" ("country_code");



CREATE INDEX "idx_images_country_id" ON "public"."images" USING "btree" ("country_id");
...
CREATE INDEX "idx_places_country_id" ON "public"."places" USING "btree" ("country_id");
...
CREATE INDEX "idx_submission_draft_routes_draft_id" ON "public"."submission_draft_routes" USING "btree" ("draft_id");



CREATE INDEX "idx_submission_draft_routes_image_order" ON "public"."submission_draft_routes" USING "btree" ("draft_image_id", "sequence_order", "created_at");
...
CREATE INDEX "images_submission_id_face_order_idx" ON "public"."images" USING "btree" ("submission_id", "face_order") WHERE ("submission_id" IS NOT NULL);



CREATE INDEX "images_submission_id_idx" ON "public"."images" USING "btree" ("submission_id") WHERE ("submission_id" IS NOT NULL);
...
CREATE OR REPLACE TRIGGER "trg_soft_delete_comments_on_climb_delete" AFTER DELETE ON "public"."climbs" FOR EACH ROW EXECUTE FUNCTION "public"."soft_delete_comments_on_target_delete"('climb');



CREATE OR REPLACE TRIGGER "trg_soft_delete_comments_on_crag_delete" AFTER DELETE ON "public"."crags" FOR EACH ROW EXECUTE FUNCTION "public"."soft_delete_comments_on_target_delete"('crag');



CREATE OR REPLACE TRIGGER "trg_soft_delete_comments_on_image_delete" AFTER DELETE ON "public"."images" FOR EACH ROW EXECUTE FUNCTION "public"."soft_delete_comments_on_target_delete"('image');
...
ALTER TABLE ONLY "public"."climbs"
    ADD CONSTRAINT "climbs_sector_id_fkey" FOREIGN KEY ("sector_id") REFERENCES "public"."sectors"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."countries"
    ADD CONSTRAINT "countries_region_id_fkey" FOREIGN KEY ("region_id") REFERENCES "public"."regions"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."crag_images"
    ADD CONSTRAINT "crag_images_sector_id_fkey" FOREIGN KEY ("sector_id") REFERENCES "public"."sectors"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."crags"
    ADD CONSTRAINT "crags_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "public"."countries"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."crags"
    ADD CONSTRAINT "crags_region_id_fkey" FOREIGN KEY ("region_id") REFERENCES "public"."regions"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."images"
    ADD CONSTRAINT "images_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "public"."countries"("id");
...
ALTER TABLE ONLY "public"."places"
    ADD CONSTRAINT "places_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "public"."countries"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."regions"
    ADD CONSTRAINT "regions_un_region_name_fkey" FOREIGN KEY ("un_region_name") REFERENCES "public"."un_regions"("name");
...
ALTER TABLE ONLY "public"."sectors"
    ADD CONSTRAINT "sectors_crag_id_fkey" FOREIGN KEY ("crag_id") REFERENCES "public"."crags"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."submission_draft_routes"
    ADD CONSTRAINT "submission_draft_routes_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."submission_draft_routes"
    ADD CONSTRAINT "submission_draft_routes_draft_id_fkey" FOREIGN KEY ("draft_id") REFERENCES "public"."submission_drafts"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."submission_draft_routes"
    ADD CONSTRAINT "submission_draft_routes_draft_image_id_fkey" FOREIGN KEY ("draft_image_id") REFERENCES "public"."submission_draft_images"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."submission_draft_routes"
    ADD CONSTRAINT "submission_draft_routes_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."un_regions"
    ADD CONSTRAINT "un_regions_continent_name_fkey" FOREIGN KEY ("continent_name") REFERENCES "public"."continents"("name");
...
CREATE POLICY "Owner can delete own images" ON "public"."images" FOR DELETE USING (("auth"."uid"() = "created_by"));
...
CREATE POLICY "Owner delete submission_draft_images" ON "public"."submission_draft_images" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."submission_drafts" "d"
  WHERE (("d"."id" = "submission_draft_images"."draft_id") AND ("d"."status" = 'draft'::"text") AND ("d"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users read own or shared submission_draft_routes" ON "public"."submission_draft_routes" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."submission_drafts" "d"
  WHERE (("d"."id" = "submission_draft_routes"."draft_id") AND (("d"."user_id" = "auth"."uid"()) OR "public"."is_submission_draft_collaborator"("d"."id", "auth"."uid"()))))));
...
CREATE POLICY "Users write own or shared submission_draft_routes" ON "public"."submission_draft_routes" USING ((EXISTS ( SELECT 1
   FROM "public"."submission_drafts" "d"
  WHERE (("d"."id" = "submission_draft_routes"."draft_id") AND ("d"."status" = 'draft'::"text") AND (("d"."user_id" = "auth"."uid"()) OR "public"."is_submission_draft_collaborator"("d"."id", "auth"."uid"())))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."submission_drafts" "d"
  WHERE (("d"."id" = "submission_draft_routes"."draft_id") AND ("d"."status" = 'draft'::"text") AND (("d"."user_id" = "auth"."uid"()) OR "public"."is_submission_draft_collaborator"("d"."id", "auth"."uid"()))))));
...
GRANT ALL ON FUNCTION "public"."add_correction_type_value"("p_type" "text", "p_value" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."add_correction_type_value"("p_type" "text", "p_value" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_correction_type_value"("p_type" "text", "p_value" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_notification"("p_target_user_id" "uuid", "p_type" character varying, "p_title" "text", "p_message" "text", "p_link" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_notification"("p_target_user_id" "uuid", "p_type" character varying, "p_title" "text", "p_message" "text", "p_link" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_notification"("p_target_user_id" "uuid", "p_type" character varying, "p_title" "text", "p_message" "text", "p_link" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_account_atomic"("p_user_id" "uuid", "p_email" "text", "p_delete_route_uploads" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_climbs_with_consensus"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_climbs_with_consensus"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_climbs_with_consensus"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_place_rankings_leaderboard"("p_place_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text", "p_region_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text", "p_region_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text", "p_region_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_rankings_leaderboard"("p_gender" "text", "p_region_id" "uuid", "p_sort" "text", "p_page" integer, "p_limit" integer, "p_window_start" timestamp with time zone) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_upload_context"("search_lat" double precision, "search_lng" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_upload_context"("search_lat" double precision, "search_lng" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_upload_context"("search_lat" double precision, "search_lng" double precision) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."rankings_grade_from_points"("p_points" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."rankings_grade_from_points"("p_points" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."rankings_grade_from_points"("p_points" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."rankings_grade_from_points"("p_points" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."soft_delete_comments_on_target_delete"() TO "anon";
GRANT ALL ON FUNCTION "public"."soft_delete_comments_on_target_delete"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."soft_delete_comments_on_target_delete"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_submission_draft_routes"("p_draft_id" "uuid", "p_draft_image_id" "uuid", "p_routes" "jsonb") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_submission_image_metadata"("p_image_id" "uuid", "p_latitude" double precision, "p_longitude" double precision, "p_face_directions" "text"[], "p_location_mode" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_submission_image_order"("p_submission_id" "uuid", "p_image_ids" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_can_edit_submission_draft"("p_draft_id" "uuid", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."submission_draft_routes" TO "anon";
GRANT ALL ON TABLE "public"."submission_draft_routes" TO "authenticated";
GRANT ALL ON TABLE "public"."submission_draft_routes" TO "service_role";
...
GRANT ALL ON TABLE "public"."un_regions" TO "anon";
GRANT ALL ON TABLE "public"."un_regions" TO "authenticated";
GRANT ALL ON TABLE "public"."un_regions" TO "service_role";
