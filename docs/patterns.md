...
- **Network-first vs Cache-first:** Routes = network-first, media = cache-first, map tiles = cache-only
- **Storage quota:** Handle `QuotaExceededError`; prompt user to clear offline data
