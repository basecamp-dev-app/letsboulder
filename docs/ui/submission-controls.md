...
## Legacy Submit Controls

The files below are not imported by the current `/submit` intake or draft editor. Do not use them as canonical contracts merely because they remain under `app/submit/components`:

- [`CountrySelector.tsx`](../../app/submit/components/CountrySelector.tsx)
- [`RegionSelector.tsx`](../../app/submit/components/RegionSelector.tsx)
- [`LocationPicker.tsx`](../../app/submit/components/LocationPicker.tsx)
- [`FaceDirectionPicker.tsx`](../../app/submit/components/FaceDirectionPicker.tsx)
- [`CragImageCanvasPicker.tsx`](../../app/submit/components/CragImageCanvasPicker.tsx)

The active editor composes [`DraftMetadataPanel`](../../features/draft-editor/components/DraftMetadataPanel.tsx), [`SubmissionWorkstation`](../../features/submissions/components/SubmissionWorkstation.tsx), and the canonical controls above.
