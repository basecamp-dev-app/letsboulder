      ...
      },
      {
        ...
        headers: [
          { key: 'Referrer-Policy', value: 'no-referrer' },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://sentry.io; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://*.supabase.co https://*.cloudflarestorage.com https://media-letsboulder.pages.dev https://server.arcgisonline.com https://static.letsboulder.com https://lh3.googleusercontent.com; connect-src 'self' https://*.supabase.co https://*.cloudflarestorage.com wss://*.supabase.co; font-src 'self'; frame-ancestors 'none';",
          },
