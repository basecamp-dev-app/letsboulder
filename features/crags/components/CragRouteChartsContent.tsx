...
export default function CragRouteChartsContent({ gradeDistribution, sendsByGrade, gradeSystem }: { gradeDistribution: GradeDistributionDatum[]; sendsByGrade: GradeSendDatum[]; gradeSystem: GradeSystem }) {
  return (
